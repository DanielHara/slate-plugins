...
function createLeaves(tagName, attributes, children) {
  var _attributes$marks = attributes.marks,
    marks =
      _attributes$marks === undefined ? Mark.createSet() : _attributes$marks;
  ...
  if (document) {
    document.getTexts().forEach(function(text) {
      ...
      if (__decorations != null) {
        ...
        try {
          for (
            var _iterator = __decorations[Symbol.iterator](), _step;
...
function createHyperscript() {
  ...
  var _options$blocks = options.blocks,
    ...
    decorations =
      _options$decorations === undefined ? {} : _options$decorations;
...
function normalizeCreator(value, creator) {
  ...
  throw new Error(
    "Slate hyperscript creators can be either functions, objects or strings, but you passed: " +
      value
  );
}
        ...
        i
          ? 9 === a
            ...
            ? (0 === a
                ? (v ||
                    ((v = ")"),
                    (l = l ? "Object.assign(" + l : "Object.assign({}")),
                  (l += g + "," + f),
                  (g = ""))
                : r &&
                  ((l += l ? "," + (g ? "" : "{") : "{"),
...
var createHTM = function createHTM(options) {
  var h = createHyperscript(options);
  return htm.bind(h);
};
